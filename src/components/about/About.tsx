                    ...
                    <Tabs defaultValue='personal'>
                        ...
                        <div className='text-lg mt-12 xl:mt-8'>
                            ...
                            <TabsContent value='personal'>
                                <div>
                                    <h3 className='h3 mb-4'>Software Engineer with an International Perspective</h3>
                                    <p className='subtitle max-w-xl max-auto xl:mx-8'>
                                        I build web and mobile applications across frontend and backend systems. My background in education helps me communicate clearly, collaborate thoughtfully, and keep users at the centre of my work.
                                    </p>
                                </div>
                            ...
                            <TabsContent value='skills'>
                                <div>
                                    <h3 className='h3 mb-4'>Skills I Use to Build Reliable Products</h3>
                                    <p className='subtitle max-w-xl max-auto xl:mx-8'>
                                        I continue to strengthen my skills across application development, testing, and cloud infrastructure.
                                    </p>
                                </div>
