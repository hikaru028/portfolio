...
const servicesData = [
    {
        ...
        description: 'Building clear, responsive interfaces with Angular, React, Next.js, React Native, and TypeScript.',
        bg: designImg,
    },
    {
        icon: <Blocks size={iconSize} strokeWidth={strokeWidth} color={color} />,
        title: 'Full-stack Development',
        description: 'Connecting modern frontend applications with dependable Java, Node.js, and Python backend services.',
        bg: developImg,
    },
    {
        icon: <Gem size={iconSize} strokeWidth={strokeWidth} color={color} />,
        title: 'Testing & Cloud',
        description: 'Improving application quality through unit and integration testing, with experience across AWS and Google Cloud.',
        bg: maintenanceImg,
    },
]
